  ...
  const tabs = [
    {
      ...
      description:
        "Type a business question — 'forecast Outerwear next month', 'which products are slow-moving?' — with no SQL or Odoo domain syntax.",
      icon: FirstIcon,
      id: "workflow",
      skeleton: <DesignYourWorkflowSkeleton />,
    },
    {
      title: "Grounded tools run",
      description:
        "The agent picks tools, runs a guarded read-only SELECT or an Odoo lookup, and explains the answer with the data behind it.",
      icon: SecondIcon,
      id: "tools",
      skeleton: <ConnectYourTooklsSkeleton />,
    },
    {
      title: "Approve the write-back",
      description:
        "When a change is warranted it drafts a proposal — a PO, a price update, a campaign — that executes only after you click Approve.",
      icon: ThirdIcon,
      id: "deploy",
    ...
    <Container className="border-divide border-x">
      <div className="flex flex-col items-center pt-16">
        ...
        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          Three steps — and a human stays in control of anything that writes to
          Odoo.
        </SubHeading>
        {/* Desktop Tabs */}
